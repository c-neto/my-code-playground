...
from sprintreports.settings import settings
from sprintreports import persistence, processor, jira
...
def create_report_raw(issues_collection_dto: jira.IssuesCollectionDTO):
    report_file_path = "{base_path}/{sprint}-report-raw.json".format(
        ...
        sprint=issues_collection_dto.sprint
    )
...
def get_issues_collections_from_json_file(report_raw_json_path: str) -> jira.IssuesCollectionDTO:
